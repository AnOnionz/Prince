...
<!-- Mirrored from axilthemes.com/demo/template/papr/about-us.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Oct 2019 15:12:33 GMT -->
<head>
	<!-- Basic metas
    ======================================== -->
	<meta charset="utf-8">
					...
					<div class="row align-items-center">
						<div class="col-md">
							<ul class="header-top-nav list-inline justify-content-center justify-content-md-start">
								...
								<li class="is-active"><a href="about-us.jsp">About</a></li>
							...
							<ul class="main-navigation list-inline" id="main-menu">
									...
									<ul class="submenu">
										...
										<li class="has-dropdown">
											...
											<ul class="submenu">
												...
												<li><a href="post-format-audio.jsp">Post Format Audio</a></li>
								...
								<li class="has-dropdown is-active">
									...
									<ul class="submenu">
										...
										<li class="is-active"><a href="about-us.jsp">About Us</a></li>
				...
				<div class="axil-team-grid-wrapper">
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<div class="axil-team-block m-b-xs-30">
								<a href="#" class="d-block img-container">
									<img src="assets/images/team/team-4.jpg" alt="team member 4">
								</a>
						...
						<div class="col-lg-4">
							<div class="axil-team-block m-b-xs-30">
								<a href="#" class="d-block img-container">
									<img src="assets/images/team/team-5.jpg" alt="team member 5">
								</a>
						...
						<div class="col-lg-4">
							<div class="axil-team-block m-b-xs-30">
								<a href="#" class="d-block img-container">
									<img src="assets/images/team/team-6.jpg" alt="team member 6">
								</a>
...
<!-- Mirrored from axilthemes.com/demo/template/papr/about-us.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Oct 2019 15:13:29 GMT -->
</html>