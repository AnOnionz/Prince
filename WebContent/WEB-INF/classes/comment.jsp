...
<body>
	<div class="d-none"><c:import url="/WEB-INF/classes/header.jsp" /></div>
	...
	================================================ -->
		<div class="main-content">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a
								href="${pageContext.request.contextPath}/MyListPost">List</a></li>
			...
			<!-- Banner starts -->
			<section class="banner banner__single-post banner__standard d-none">
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-12">
							<main class="site-main">
								<article class="post-details d-none">
    ...
    <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 29 34"
        ...
        <path
								...
								<div class="ui huge comments" id="commentbox" style="margin: 0;">

									<h2 class="ui dividing header">Bình luận</h2>
									<form class="ui reply form">
										<input type="hidden" value="${view.post_id}" id="idView">
										<input type="hidden" value="${valuecmt}" id="valuecmt">
										<div class="field">
									...
									$(document).ready(function(){
										...
										<div class="comment" id ="comment${item.comment_id}">
											...
											<div class="content">
												...
												<div class="actions">
													<a class="reply" id="replycmt${item.comment_id}">Trả
														lời</a>
													<c:if test="${item.user_id == user_id}">
														<a class="delete" id="delcmt${item.comment_id}">xóa</a>
													</c:if>
												</div>
												<form class="ui reply form d-none"
													id="form${item.comment_id}">
													<input type="hidden" value="${view.post_id}" id="idView">
													<div class="field">
											...
											<c:forEach items="${item.getSubCmt()}" var="sub"
												varStatus="loopp">
												<script type="text/javascript">
									$(document).ready(function(){
												...
												<div class="comments" id ="comment${sub.comment_id}">
													<div class="comment">
														...
														<div class="content">
															...
															<div class="actions">
																<a class="reply" id="replycmt${sub.comment_id}">trả
																	lời</a>
