...
<!-- Mirrored from axilthemes.com/demo/template/papr/post-format-audio.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Oct 2019 15:28:01 GMT -->
<head>
	<!-- Basic metas
    ======================================== -->
	<meta charset="utf-8">
							...
							<ul class="main-navigation list-inline" id="main-menu">
								<li class="has-dropdown">
									...
									<ul class="submenu">
										...
										<li><a href="home-2.jsp">Home Two</a></li>
										<li><a href="home-3.jsp">Home Three</a></li>
										<li><a href="home-4.jsp">Home Four</a></li>
										<li><a href="home-5.jsp">Home Five</a></li>
									</ul>
									<!-- End of .submenu -->
								</li>
								<li class="has-dropdown is-active">
									...
									<ul class="submenu">
										<li class="has-dropdown">
											...
											<ul class="submenu">
												<li><a href="post-layout-one.jsp">Post Layout 1</a></li>
												<li><a href="post-layout-two.jsp">Post Layout 2</a></li>
												<li><a href="post-layout-three.jsp">Post Layout 3</a></li>
												<li><a href="post-layout-four.jsp">Post Layout 4</a></li>
												<li><a href="post-layout-five.jsp">Post Layout 5</a></li>
											</ul>
											<!-- End of .submenu -->
										</li>
										<li class="has-dropdown is-active">
											...
											<ul class="submenu">
												<li><a href="post-format-standard.jsp">Post Format Standard</a>
												</li>
												<li><a href="post-format-video.jsp">Post Format Video</a></li>
												<li class="is-active"><a href="post-format-audio.jsp">Post Format
														Audio</a></li>
												<li><a href="post-format-gallery.jsp">Post Format Gallery</a></li>
												<li><a href="post-format-quote.jsp">Post Format Quote</a></li>
												<li><a href="post-format-text-only.jsp">Post Format Text Only</a>
												</li>
											</ul>
											<!-- End of .submenu -->
										</li>
				...
				<div class="row">
					...
					<div class="col-lg-9">
						<div class="post-title-wrapper">
							...
							<h2 class="m-b-xs-0 m-t-xs-10 axil-title hover-line">VR Is the Use of Computer Technology to
								Create a Simulated Environment.</h2>
							<div class="post-metas banner-post-metas m-t-xs-20">
								<ul class="list-inline">
									<li><a href="#" class="post-author post-author-with-img"><img
												src="assets/images/author/01.png" alt="image">Ashley Graham</a></li>
						...
						<main class="site-main">
							<article class="post-details">
								<div class="single-blog-wrapper">
									...
									<!-- End of .social-share -->
									<div class="audio mb-5"><iframe height="300" width="100%" allow="autoplay"
											src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/184476938&amp;color=%23ff2c54&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;show_teaser=true&amp;visual=true"></iframe>
									</div>
