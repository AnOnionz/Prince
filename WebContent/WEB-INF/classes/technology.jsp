...
<!-- Mirrored from axilthemes.com/demo/template/papr/technology.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Oct 2019 15:11:28 GMT -->
<head>
	<!-- Basic metas
    ======================================== -->
	<meta charset="utf-8">
					...
					<div class="navbar-inner">
						...
						<div class="main-nav-wrapper">
							<ul class="main-navigation list-inline" id="main-menu">
								...
								<li><a href="business.jsp">Business</a></li>
								<li><a href="lifestyle.jsp">Lifestyle</a></li>
								<li class="is-active"><a href="technology.jsp">Technology</a></li>
								<li><a href="sports.jsp">Sports</a></li>
								<li class="has-dropdown">
									<a href="#">Pages</a>
									<ul class="submenu">
						...
						<main class="axil-content">
							...
							<div class="media post-block post-block__mid m-b-xs-30">
								...
								<div class="media-body">
									...
									<h3 class="axil-post-title hover-line hover-line"><a
											href="post-format-standard.jsp">Hypnotherapy For
							...
							<div class="media post-block post-block__mid m-b-xs-30">
								...
								<div class="media-body">
									...
									<h3 class="axil-post-title hover-line hover-line"><a
											href="post-format-standard.jsp">How To Fly A Private Jet On Your Next
											Trip</a>
									</h3>
...
<!-- Mirrored from axilthemes.com/demo/template/papr/technology.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Oct 2019 15:11:52 GMT -->
</html>