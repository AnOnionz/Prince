			...
			<div class="container">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/MyListPost">List</a></li>
		...
		<section class="banner banner__single-post banner__standard">
			<div class="container">
				<div class="row align-items-center">
							...
							<div class="post-metas banner-post-metas m-t-xs-20">
								<ul class="list-inline">
									<li><a href="#" class="post-author post-author-with-img"><img
											src="assets/images/author/01.png" alt="author">${view.getAuthor()}</a></li>
									<li><a href="#"><i class="feather icon-activity"></i>${view.visiter }
											Lượt xem</a></li>
								</ul>
							</div>
							<!-- End of .post-metas -->
					...
					<div class="col-lg-6">
						<img src="${view.image}" alt="ảnh bìa" 
							class="img-fluid rounded" width="600" height="600">
					</div>
				</div>
				<!-- End of .row -->
			</div>
							...
							<article class="post-details">
								<div class="single-blog-wrapper">
									...
									<figure>
										<img  class="rounded"
											src="${view.image1}"
											alt="img" style="margin: 0 11rem; width: 80%;">
										<figcaption>${view.figure1}</figcaption>
									</figure>
									...
									<figure>
										<img class="rounded"
											src="${view.image2}"
											alt="img" style="margin: 0 11rem; width: 80%;">
										<figcaption>${view.figure2}</figcaption>
									</figure>
									<!-- End of .gallery -->
									...
									<figure class="post-media">
										<video class="plyr-post"
											...
											<source src="${view.video}"
												type="video/mp4">
										</video>
										<figcaption>${view.figure3}</figcaption>
									</figure>
...
<div class="contai mb-5 " id="1">
  ...
  <a href="${view.url}" target="_blank"><span class="pulse-button" id = "recive">Nhận 10</span></a>
</div>
<div class='contai mb-5' id="2">
 <span class="pulse-button" id="time"></span>
	...
	<c:if test="${empty(view)}">
	<div class="row">
	<div class="col-12 m-t-xs-100" style="text-align: center;" >Quảng cáo không tồn tại</div>
	</div>
	</c:if>
</body>
<script type="text/javascript">
