...
<body>
	...
	ArrayList<Post> postRandom = new ArrayList();
						...
						<div class="axil-latest-post">
							<div class="media post-block m-b-xs-20">
								<figure class="fig-container">
									<a><img id="view<%=postPresent.get(0).getPost_id()%>"
										src="<%=postPresent.get(0).getImage() %>" alt="latest post"></a>
								...
								<div class="media-body">
									<h3 id="viewTitle<%=postPresent.get(0).getPost_id()%>"
										class="axil-post-title hover-line hover-line"
										style="word-wrap: break-word; cursor: default;">
										<a><%=postPresent.get(0).getTitle()%></a>
									</h3>
									<div class="post-metas">
										<ul class="list-inline">
											<li>Đăng bởi <a class="post-author"
												style="font-weight: bold;"><%=postPresent.get(0).getAuthorName() %></a></li>
											<li><i class="dot">.</i><%=postPresent.get(0).getStartDate()%></li>
											<li><a><i class="feather icon-activity"></i><%=postPresent.get(0).getVisiter()%>
													lượt xem</a></li>
								...
								<div class="media post-block m-b-xs-30">
									...
									<div class="media-body">
										...
										<h3 id="viewTitle<%=postPresent.get(0).getPost_id()%>"
											class="axil-post-title hover-line hover-line"
											style="word-wrap: break-word; cursor: default;">
											<a><%=postPresent.get(i).getTitle()%></a>
										</h3>
										<div class="post-metas">
											<ul class="list-inline">
		...
		<section
			class="axil-video-posts section-gap section-gap-top__with-text bg-grey-dark-one">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-8">
						<div class="axil-img-container flex-height-container"
							...
							<div
								class="media post-block grad-overlay__transparent position-absolute m-b-xs-30">
								<div class="media-body media-body__big">
									<div class="axil-media-bottom mt-auto">
										<h3 class="axil-post-title hover-line hover-line"
											id="viewTitle<%=videoPresent.get(0).getPost_id()%>"
											style="word-wrap: break-word; cursor: default;">
											<a><%=videoPresent.get(0).getTitle()%></a>
										</h3>
										<div class="post-metas">
											<ul class="list-inline">
												...
												<li><a><i class="feather icon-activity"></i><%=videoPresent.get(0).getVisiter()%>
														lượt xem</a></li>
											</ul>
										</div>
									</div>
							...
							<div
								...
								<div class="media-body">
									<div class="post-cat-group">
										<a class="post-cat color-blue-three" style="background: #fff;"><%=videoPresent.get(i).getCategoryName()%></a>
									</div>
									<h3 class="axil-post-title hover-line hover-line"
										id="viewTitle<%=videoPresent.get(i).getPost_id()%>"
										style="word-wrap: break-word; cursor: default;">
										<a><%=videoPresent.get(i).getTitle()%></a>
									</h3>
									<div class="post-metas">
										<ul class="list-inline">
											<li>Đăng bởi <a class="post-author font-weight-bold"><%=videoPresent.get(i).getAuthorName()%></a></li>
										</ul>
									</div>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-lg-8">
						<div class="add-container m-b-xs-60">
							<a href="#"><img
								src="assets/images/clientbanner/clientbanner.jpg" alt="add one"
								class="img-fluid"></a>
						</div>
						...
						%>
							<div class="media post-block post-block__mid m-b-xs-30">
								...
								<div class="media-body">
									...
									<h3 class="axil-post-title hover-line hover-line" id="viewTitle<%=item.getPost_id()%>"
										style="word-wrap: break-word; cursor: default;">
										<a><%=item.getTitle()%></a>
									</h3>
							...
							<script>
        $(document).ready(function () {
            jQuery("#view<%=item.getPost_id()%>,#viewTitle<%=item.getPost_id()%>").click(function(){
                var id = <%=item.getPost_id()%>;
                var location = "home";
                $.ajax({
                    url: 'View',
                    type: 'POST',
					...
					<div class="col-lg-4">
						<aside class="post-sidebar">
							<div class="add-block-widget m-b-xs-40">
								<a href="#"><img
									src="assets/images/clientbanner/clientbanner2.jpg"
									alt="sidebar add" class="img-fluid"></a>
							</div>
							<div
								class="newsletter-widget weekly-newsletter bg-grey-light-three m-b-xs-40">
								<div class="newsletter-content">
									...
									<div class="section-title">
										...
										<p class="mid m-t-xs-10 m-b-xs-20">No spam, notifications
											only about new products, updates.</p>
									</div>
									<!-- End of .section-title -->
									<div class="subscription-form-wrapper">
										<form action="#" class="subscription-form">
											<div class="form-group form-group-small m-b-xs-20">
												<label for="subscription-email-2">Enter Email
													Address</label> <input type="text" name="subscription-email-2"
							...
							<div class="category-widget m-b-xs-40">
								...
								<div class="category-carousel">
									<div class="owl-carousel owl-theme" data-owl-items="1"
										data-owl-loop="true" data-owl-autoplay="true"
										data-owl-dots="false" data-owl-nav="false"
										data-owl-margin="10">
										<div class="cat-carousel-inner">
											<ul class="category-list-wrapper">
												<li class="category-list perfect-square"><a
													href="post-format-standard.jsp" class="list-inner"
							...
							<div class="sidebar-social-share-widget m-b-xs-40">
								<ul class="social-share-list-wrapper">
									<li class="social-share-list text-center perfect-square">
										<a href="#" class="list-inner bg-color-facebook"> <i
									...
									<li class="social-share-list text-center perfect-square">
										<a href="#" class="list-inner bg-color-twitter"> <i
									...
									<!-- End of .social-share-list -->
									<li class="social-share-list text-center perfect-square">
										<a href="#" class="list-inner bg-color-youtube"> <i
									...
									<!-- End of .social-share-list -->
									<li class="social-share-list text-center perfect-square">
										<a href="#" class="list-inner bg-color-linkedin"> <i
									...
									<!-- End of .social-share-list -->
									<li class="social-share-list text-center perfect-square">
										<a href="#" class="list-inner bg-color-vimeo"> <i
									...
									<!-- End of .social-share-list -->
									<li class="social-share-list text-center perfect-square">
										<a href="#" class="list-inner bg-color-pinterest"> <i
									...
									<!-- End of .social-share-list -->
									<li class="social-share-list text-center perfect-square">
										<a href="#" class="list-inner bg-color-twitch"> <i
									...
									<!-- End of .social-share-list -->
									<li class="social-share-list text-center perfect-square">
										<a href="#" class="list-inner bg-color-instagram"> <i
							...
							<div class="post-widget sidebar-post-widget m-b-xs-40">
								<ul class="nav nav-pills row no-gutters">
									<li class="nav-item col"><a class="nav-link active"
										data-toggle="pill" href="#recent-post">Recent</a></li>
									<li class="nav-item col"><a class="nav-link"
										data-toggle="pill" href="#popular-post">Popular</a></li>
									<li class="nav-item col"><a class="nav-link"
										data-toggle="pill" href="#comments">Comments</a></li>
								</ul>
										...
										<div class="axil-content">
											<div class="media post-block post-block__small">
												<a href="post-format-standard.jsp" class="align-self-center"><img
													class=" m-r-xs-30"
													src="assets/images/media/small-media-1.jpg"
													alt="media image"></a>
												<div class="media-body">
													<div class="post-cat-group">
														<a href="post-format-standard.jsp"
															class="post-cat color-blue-three">BEAUTY,</a> <a
															href="post-format-standard.jsp"
															class="post-cat color-yellow-one">TRADE,</a> <a
															href="post-format-standard.jsp"
															class="post-cat color-red-one">MUSIC</a>
													</div>
													<h4 class="axil-post-title hover-line hover-line">
														<a href="post-format-standard.jsp">Stocking Your
															Restaurant Kitchen Finding Reliable Sellers</a>
													</h4>
													<div class="post-metas">
														<ul class="list-inline">
											...
											<div class="media post-block post-block__small">
												<a href="post-format-standard.jsp" class="align-self-center"><img
													class=" m-r-xs-30"
													src="assets/images/media/small-media-2.jpg"
													alt="media image"></a>
												<div class="media-body">
													<a href="post-format-standard.jsp"
														class="post-cat color-green-three">TRAVEL</a>
													<h4 class="axil-post-title hover-line hover-line">
														<a href="post-format-standard.jsp">Trip To Iqaluit In
															Nunavut A Canadian Arctic City</a>
													</h4>
													<div class="post-metas">
														<ul class="list-inline">
											...
											<div class="media post-block post-block__small">
												<a href="post-format-standard.jsp" class="align-self-center"><img
													class=" m-r-xs-30"
													src="assets/images/media/small-media-3.jpg"
													alt="media image"></a>
												<div class="media-body">
													<a href="post-format-standard.jsp"
														class="post-cat color-red-two">SPORTS</a>
													<h4 class="axil-post-title hover-line hover-line">
														<a href="post-format-standard.jsp">Thousands Now
											...
											<div class="media post-block post-block__small">
												<a href="post-format-standard.jsp" class="align-self-center"><img
													class=" m-r-xs-30"
													src="assets/images/media/small-media-4.jpg"
													alt="media image"></a>
												<div class="media-body">
													<a href="post-format-standard.jsp"
														class="post-cat color-blue-one">FASHION</a>
													<h4 class="axil-post-title hover-line hover-line">
														<a href="post-format-standard.jsp">To Keep Makeup
															Looking Fresh Take A Powder</a>
													</h4>
													<div class="post-metas">
														<ul class="list-inline">
											...
											<div class="media post-block post-block__small">
												...
												<div class="media-body">
													<a href="post-format-standard.jsp"
														class="post-cat color-red-two">SPORTS</a>
													<h4 class="axil-post-title hover-line hover-line">
														<a href="post-format-standard.jsp">RCB vs RR, IPL
															2019: Bangalore, Rajasthan desperate for win</a>
													</h4>
													<div class="post-metas">
														<ul class="list-inline">
															<li>By <a href="#">Ahmad Nazeri</a></li>
										...
										<div class="axil-content">
											...
											<div class="media post-block post-block__small">
												...
												<div class="media-body">
													...
													<div class="post-metas">
														<ul class="list-inline">
															<li>By <a href="post-format-standard.jsp">Xu
																	Jianhong</a>
															</li>
														</ul>
													</div>
							...
							<div class="instagram-widget m-b-xs-40">
								...
								<div class="axil-content">
									<ul class="instagram-post-list-wrapper">
										<li class="instagram-post-list perfect-square"><a
											href="#" class="list-inner"
											style="background-image: url(assets/images/instagram-post/instagram-post-1.jpg)">
												<div class="post-info-wrapper overlay">
													<div class="post-info">
														<i class="feather icon-heart"></i> 20K+
													</div>
													<!-- End of .post-info -->
													<div class="post-info">
														<i class="feather icon-message-square"></i> 200+
													</div>
													<!-- End of .post-info -->
												</div> <!-- End of .post-info-wrapper overlay -->
										</a></li>
