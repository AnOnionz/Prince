...
<!-- Mirrored from axilthemes.com/demo/template/papr/post-format-gallery.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Oct 2019 15:28:01 GMT -->
<head>
	<!-- Basic metas
    ======================================== -->
	<meta charset="utf-8">
									...
									<ul class="submenu">
										...
										<li class="has-dropdown is-active">
											...
											<ul class="submenu">
												...
												<li class="is-active"><a href="post-format-gallery.jsp">Post Format
														Gallery</a></li>
