...
<!-- Mirrored from axilthemes.com/demo/template/papr/post-layout-five.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Oct 2019 15:27:50 GMT -->
<head>
	<!-- Basic metas
    ======================================== -->
	<meta charset="utf-8">
									...
									<ul class="submenu">
										<li class="has-dropdown is-active">
											...
											<ul class="submenu">
												...
												<li class="is-active"><a href="post-layout-five.jsp">Post Layout 5</a>
												</li>
											</ul>
											<!-- End of .submenu -->
										</li>
		...
		<section class="banner banner__single-post banner__standard">
			<div class="container">
				<div class="row align-items-center">
						...
						<div class="post-title-wrapper">
							...
							<div class="post-metas banner-post-metas m-t-xs-30">
								<ul class="list-inline">
									...
									<li><i class="dot">.</i>April 17, 2019</li>
					...
					<div class="col-lg-6">
						<img src="assets/images/banner-gallery/banner-gallery-5.jpg" alt="" class="img-fluid"
...
<!-- Mirrored from axilthemes.com/demo/template/papr/post-layout-five.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Oct 2019 15:28:01 GMT -->
</html>