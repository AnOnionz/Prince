...
<!-- Mirrored from axilthemes.com/demo/template/papr/post-format-quote.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Oct 2019 15:28:01 GMT -->
<head>
	<!-- Basic metas
    ======================================== -->
	<meta charset="utf-8">
									...
									<ul class="submenu">
										...
										<li class="has-dropdown is-active">
											...
											<ul class="submenu">
												...
												<li class="is-active"><a href="post-format-quote.jsp">Post Format
														Quote</a></li>
							...
							<article class="post-details">
								<div class="single-blog-wrapper">
									...
									<div class="post-title-wrapper m-b-xs-30">
										<h2 class="m-b-xs-0 axil-post-title hover-line">Windows Registry Cleaner
											Checklist</h2>
