...
<!-- Mirrored from axilthemes.com/demo/template/papr/post-format-text-only.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Oct 2019 15:28:01 GMT -->
<head>
    <!-- Basic metas
		======================================== -->
    <meta charset="utf-8">
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li class="has-dropdown is-active">
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li class="is-active"><a href="post-format-text-only.jsp">Post Format
                                                        Text Only</a>
                                                </li>
                                            </ul>
                                            <!-- End of .submenu -->
                            ...
                            <article class="post-details">
                                <div class="single-blog-wrapper">
                                    ...
                                    <p> For those of us who want to say thank you to our moms, it’s not always easy to
                                        put those big feelings in words. <em>Which is where Dribbble comes in.</em></p>
                                    <p>These eight shots crystallize the hard work moms put into keeping their kids
                                        <strong>alive, happy, and healthy.</strong> They might give you the inspiration
                                        you need for
