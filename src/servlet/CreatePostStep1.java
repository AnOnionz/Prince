		...
		post = (Post) request.getSession().getAttribute("post");
			...
			case "1":
				...
				if((Post)request.getSession().getAttribute("post")==null) {
					...
					RequestDispatcher dispatcher2 = this.getServletContext().getRequestDispatcher("/WEB-INF/classes/uppoststep1.jsp");
			...
			case "2":
				...
				case "1":
					...
					break;
				case "2":
					RequestDispatcher dispatcher3 = this.getServletContext().getRequestDispatcher("/WEB-INF/classes/uppoststep3.jsp");
					dispatcher3.forward(request, response);
					break;
				default:
					if(request.getSession().getAttribute("extend")=="open") {
						RequestDispatcher dispatcher1 = this.getServletContext().getRequestDispatcher("/WEB-INF/classes/uppoststep3.jsp");
